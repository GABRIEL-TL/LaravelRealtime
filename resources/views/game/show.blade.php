                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img id="circle" class="" width="250" height="250"
                                src="{{ asset('img/circle.png') }}" alt="">
                            <p id="winner" class="display-1 d-none text-primary"></p>
                        </div>
                        <hr>
                        <div class="text-center">
                            <label for="bet" class="font-weight-bold h5">Your bet</label>
                            <select id="bet" name="bet" class="form-select col-auto">
...
@push('scripts')
    <script type="module">
        ...
        Echo.channel('game')
        .listen('RemainingTimeChanged',({time})=>{
        ...
        .listen('WinnerNumberGenerated',({number:winner})=>{
